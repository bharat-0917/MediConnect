...
INSERT INTO "new_LabReport" ("aiFlaggedAnomalies", "aiSummary", "fileType", "fileUrl", "id", "patientId", "title", "uploadedAt", "uploadedByUserId") SELECT "aiFlaggedAnomalies", "aiSummary", "fileType", "fileUrl", "id", "patientId", "title", "uploadedAt", "uploadedByUserId" FROM "LabReport";
